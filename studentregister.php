...
<body>
   <div class="reg-box">
    ...
    <div class="form">
    <form style="font-size: 15px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;" method="post" action="studentregister.php">
        <label for="uname"> Student ID number:</label><br>
        ...
        <div class="result">
            ...
            if(isset($_POST["submit"])){
                ...
                $fetchsql="select * from studentreg;";
                $inssql="insert into studentreg values('$sid','$email','$pass','$con_pass');";
                $found=false;
                $res=false;
                $fetchres=mysqli_query($con,$fetchsql);
                if(empty($sid)||empty($email)||empty($pass)||empty($con_pass)){
